...
dodec5EqualCapacities <- expand.grid(method = c(methods, c("gsFS", "gsFE")), demand = 5L, n = 50000L, nCapacities = 5, interestVertices = "1,20", stringsAsFactors=FALSE, epsilon = c(0.01, 0.001, 0.0001), graph = "dodecahedron5EqualCapacity")

dodec15UnequalCapacities <- expand.grid(method = c(methods, c("gsFS", "gsFE")), demand = 25L, n = 50000L, nCapacities = 15, interestVertices = "1,20", stringsAsFactors=FALSE, epsilon = c(0.01, 0.001, 0.0001), graph = "dodecahedron15UnequalCapacity")
...
grid10x10_2Scenarios <- expand.grid(method = c("pmc", "gsFS"), demand = 50, n = 50000L, nCapacities = 10, interestVertices = "101,102", stringsAsFactors=FALSE, epsilon = 1, graph = "grid10x10_2")
