...
grid5x5_1Scenarios <- expand.grid(method = c("turnipFull1", "gsFS"), demand = 10, n = 50000L, nCapacities = 8, interestVertices = "1,25", stringsAsFactors=FALSE, epsilon = c(1e-5, 1e-6, 1e-7, 1e-8, 1e-9), graph = "grid5x5_1")
...
scenarios <- rbind(grid3x3_1Scenarios, grid5x5_1Scenarios, grid10x10_1Scenarios, dodec5EqualCapacities)
