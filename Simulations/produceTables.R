...
captions <- list()
captions[["grid5x5_1"]] <- "Simulation results for the $5 \\times 5$ grid graph. The vertices of interest were diagonally opposite corners of the graph. For edges incident to the vertices of interest, $b_i = 12$. For all other edges, $b_i = 8$. $\\rho = 0.6$ for all edges. The demand threshold was 20. "
...
captions[["grid5x5_2"]] <- "Simulation results for the augmented $5 \\times 5$ grid graph. The vertices of interest were vertices 26 and 27. Vertex 26 was connected to every vertex on one side of the grid, and vertex 27 connected to every vertex on the opposite side. For all edges $\\rho = 0.5$ and $b_i = 10$. The demand threshold was 50."
